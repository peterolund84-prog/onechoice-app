...
BUILD_ID = "lista-klart-lifecycle-v32-20260722"
...
I18N = {
    "sv": {
        ...
        "list_add_placeholder": "Lägg till vara…",
        "list_done": "Klart",
...
.st-key-lista_page_title .oc-logo {{
...
def page_lista() -> None:
    render_top_chrome()
    require_auth_context()
    with st.container(key="lista_page_title"):
        st.markdown(
            f'<p class="oc-logo">{html.escape(t("list_title"))}</p>',
            unsafe_allow_html=True,
        )
